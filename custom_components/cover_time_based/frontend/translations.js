...
export const TRANSLATIONS = {
  ...
  de: {
    ...
    "timing.tilt_attribute_header": "Attribut",
  ...
  it: {
    ...
    "control_mode.switch": "Interruttore (bistabile)",
    ...
    "timing.tilt_attribute_header": "Attributo",
  ...
  nl: {
    ...
    "timing.tilt_attribute_header": "Attribuut",
  ...
  fr: {
    ...
    "control_mode.switch": "Interrupteur (bistable)",
    ...
    "tilt_motor.safe_position": "Position d'inclinaison sûre",
    ...
    "relay_reports_off.helper":
      "Laissez cette option activée pour les relais à bascule ordinaires, qui se désactivent d'eux-mêmes après l'impulsion et le rapportent. Désactivez-la pour les modules à impulsion gérés par le matériel (par exemple l'Aqara T2), qui génèrent l'impulsion en interne mais ne rapportent jamais leur désactivation, laissant l'entité d'interrupteur bloquée sur activée. Une fois désactivée, l'intégration n'envoie qu'une seule commande ACTIVER par appui, et jamais de commande DÉSACTIVER — chaque appui correspond ainsi exactement à une activation propre, sans commande dupliquée.",
    "send_endpoint_stop.label": "Envoyer un signal d'arrêt en fin de course",
    "send_endpoint_stop.helper":
      "Lorsque votre volet atteint l'ouverture ou la fermeture complète, envoyer l'impulsion d'arrêt. Gardez cette option activée pour les contrôleurs qui continuent de fonctionner tant qu'ils n'ont pas reçu d'arrêt (sans quoi le volet se bloque et les boutons physiques ne répondent plus). Désactivez-la si votre moteur s'arrête de lui-même en fin de course et qu'un arrêt supplémentaire le fait aller à une position prédéfinie/favorite.",
    ...
    "recalibrate_before_position.helper":
      "Pour les volets sans retour de position qu'une télécommande peut aussi actionner. Ouvre complètement le volet avant chaque commande de position, afin que le mouvement parte d'une position connue plutôt que d'une estimation dérivée. Cela double à peu près la course de chaque mouvement et, avec une inclinaison pendant la course ou séquentielle, le volet bouge lorsque vous réglez les lames.",
    ...
    "hints.dual_motor.travel_time_close": "Commencez avec le volet ouvert et les lames en position sûre. Cliquez sur Terminer lorsque le volet est complètement fermé.",
    "hints.dual_motor.travel_time_open": "Commencez avec le volet fermé et les lames en position sûre. Cliquez sur Terminer lorsque le volet est complètement ouvert.",
  ...
  es: {
    ...
    "control_mode.switch": "Interruptor (biestable)",
    "control_mode.pulse": "Impulso (momentáneo)",
    "control_mode.toggle": "Conmutación (mismo botón)",
    "control_mode.toggle_opposite": "Conmutación (botón opuesto)",
    ...
    "entities.ignore_reported_position_helper":
      "Seguir la posición solo por tiempo e ignorar la posición que informa la persiana envuelta. Activa esta opción si la persiana subyacente informa una posición poco fiable.",
    "entities.force_time_based_position": "Forzar el posicionamiento por tiempo",
    "entities.force_time_based_position_helper":
      "De forma predeterminada, si la persiana envuelta admite establecer la posición, el comando de posición se le envía directamente. Activa esta opción para gobernarla en su lugar con apertura/cierre/parada temporizados, ignorando su compatibilidad nativa con el establecimiento de posición.",
    "entities.reports_command_not_endpoint": "Informa comandos, no finales de carrera",
    "entities.reports_command_not_endpoint_helper":
      "Actívalo para persianas (por ejemplo, algunas persianas Tuya) cuyo estado abierto/cerrado/desconocido es un eco del comando en lugar de un final de carrera real: no informan ninguna transición de apertura o cierre ni ninguna posición. El estado se trata como un comando de abrir/cerrar/detener y la posición se sigue por tiempo.",
    "entities.invert": "Invertir la posición",
    "entities.invert_helper":
      "Invierte el eje de posición: informa 100 − la posición de la persiana envuelta e intercambia apertura y cierre. Úsalo para persianas que funcionan al revés, por ejemplo un toldo cuya entidad subyacente informa abierto = extendido. Solo afecta al eje de posición; la lógica de inclinación no cambia: está pensado para cubiertas que solo tienen posición (toldos/persianas enrollables), no para venecianas con lamas orientables.",
    "entities.switch_entities": "Entidades de interruptor",
    ...
    "relay_reports_off.label": "El relé informa su propia desconexión",
    "relay_reports_off.helper":
  ...
  ca: {
    ...
    "loading": "Carregant...",
    "saving": "Desant...",
    "save_failed": "Error en desar — valor restaurat",
    ...
    "entities.ignore_reported_position_helper":
      "Fes el seguiment de la posició només pel temps i ignora la posició que informa la persiana embolcallada. Activa aquesta opció si la persiana subjacent informa una posició poc fiable.",
    "entities.force_time_based_position": "Força el posicionament per temps",
    "entities.force_time_based_position_helper":
      "Per defecte, si la persiana embolcallada admet establir la posició, l'ordre de posició se li envia directament. Activa aquesta opció per governar-la amb obertura/tancament/aturada temporitzats, ignorant-ne la compatibilitat nativa amb l'establiment de posició.",
    "entities.reports_command_not_endpoint": "Informa ordres, no finals de cursa",
    "entities.reports_command_not_endpoint_helper":
      "Activa-ho per a persianes (per exemple, algunes persianes Tuya) l'estat obert/tancat/desconegut de les quals és un eco de l'ordre en lloc d'un final de cursa real: no informen cap transició d'obertura o tancament ni cap posició. L'estat es tracta com una ordre d'obrir/tancar/aturar i el seguiment de la posició es fa pel temps.",
    "entities.invert": "Inverteix la posició",
    "entities.invert_helper":
      "Inverteix l'eix de posició: informa 100 − la posició de la persiana embolcallada i intercanvia obertura i tancament. Fes-ho servir per a persianes que funcionen al revés, per exemple un tendal l'entitat subjacent del qual informa obert = desplegat. Només afecta l'eix de posició; la lògica d'inclinació no canvia: està pensat per a cobertes que només tenen posició (tendals/persianes enrotllables), no per a venecianes amb lamel·les orientables.",
    ...
    "relay_reports_off.label": "El relé informa la seva pròpia desconnexió",
    "relay_reports_off.helper":
      "Deixa-ho activat per als relés de commutació normals, que es desconnecten sols després de l'impuls i ho informen. Desactiva-ho per als mòduls d'impuls gestionats pel maquinari (per exemple, l'Aqara T2), que generen l'impuls internament però mai informen quan es desconnecten, i deixen l'entitat d'interruptor encallada en activada. Amb l'opció desactivada, la integració només envia una única ordre d'ACTIVACIÓ per pulsació i mai cap de DESACTIVACIÓ, de manera que cada pulsació és exactament una activació neta, sense ordres duplicades.",
    "send_endpoint_stop.label": "Envia un senyal d'aturada als finals de cursa",
    "send_endpoint_stop.helper":
      "Quan la persiana arriba a totalment oberta o tancada, envia l'impuls d'aturada. Mantén aquesta opció activada per als controladors que continuen funcionant fins que reben una aturada (si no, la persiana es queda encallada i els botons físics deixen de respondre). Desactiva-la si el motor s'atura sol als finals de cursa i una aturada addicional el fa anar a una posició predefinida o preferida.",
    "force_endpoint_redrive.label": "Torna a enviar sempre obrir/tancar als finals de cursa",
    "force_endpoint_redrive.helper":
      "Per a persianes sense realimentació de posició que també es poden moure amb un comandament a distància extern, de manera que Home Assistant pot creure erròniament que ja són totalment obertes o tancades. Quan està activat, una ordre d'obrir o tancar s'executa sempre durant tot el temps de recorregut encara que Home Assistant cregui que la persiana ja hi és, cosa que garanteix que l'ordre arriba al motor. Deixa-ho desactivat per a les persianes que informen la seva pròpia posició.",
    "recalibrate_before_position.label": "Obre totalment abans de moure a una posició (Beta)",
    "recalibrate_before_position.helper":
      "Per a persianes sense realimentació de posició que un comandament a distància també pot moure. Obre la persiana del tot abans de cada ordre de posició, perquè el moviment parteixi d'una posició coneguda en lloc d'una estimació desviada. Duplica aproximadament el recorregut de cada moviment i, amb inclinació durant el recorregut o seqüencial, mou la persiana quan ajustes les lamel·les.",
    "more_info": "Més informació",
    "timing.attribute_header": "Atribut",
    "timing.travel_attribute_header": "Atribut",
    "timing.tilt_attribute_header": "Atribut",
    "timing.value_header": "Valor",
