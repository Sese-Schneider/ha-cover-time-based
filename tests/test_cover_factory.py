...
class TestCreateCoverFromOptions:
    ...
    def test_passes_common_params(self):
        ...
        assert cover._travel_time_up == 20.0
        assert cover._tilting_time_down == 5.0
        assert cover._tilting_time_up == 4.0
        assert cover._travel_moves_with_tilt is True
...
class TestDevicesFromConfig:
    ...
    def test_defaults_applied(self):
        ...
        devices = devices_from_config(config)
        cover = devices[0]
        assert cover._travel_time_down == 15.0
        assert cover._travel_time_up == 12.0
        assert cover._tilting_time_down == 3.0
        assert cover._tilting_time_up == 2.5
    ...
    def test_device_config_overrides_defaults(self):
        ...
        devices = devices_from_config(config)
        assert devices[0]._travel_time_down == 25.0
